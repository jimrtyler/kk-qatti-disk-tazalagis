...
#GUI Variables
$FormTitleText = "Джим Тайлердің диск тазалағышы (PowerShellEngineer.com)"
$SelectDiskLabelText = "Дискіні таңдау:"
$FreeSpaceLabelText = "Бос орын (гигабайт): "
$TotalSpaceLabelText = "Жалпы бос орын (гигабайт): "
$JunkFoundLabelText = "қоқыс табылды (гигабайт):"
$CleanDiskBtnText = "Дискіні тазалау *Файлдарды жою*"
$SpaceCleanedLabelText = "Тазаланған кеңістік (гигабайт): "
$LogFileLabelText = "Журналы файл табылды: $abcdefg"
$CreditLabelText = "Джим Тайлер сценарийі - PowerShellEngineer.com"
$LogFileLocatedText = "Журналы файл табылды"
$AnalyzingDriveText = "Драйверлерді талдау..."
$BrowsersAreRunningText = "Браузерлер жұмыс істейді... Пайдаланушыға хабарлау..."
$PleaseCloseBrowsersText = "Барлық веб-шолғыштарды жауып, әрекетті қайталаңыз."
$CleaningDriveText = "Дискіні тазалау..."
